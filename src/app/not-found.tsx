...
export default function NotFoundPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "IT Training",
      description:
        "Empower your team with cutting-edge technical skills and certifications",
      link: "/training",
    },
    {
      icon: Database,
      ...
      description:
        "Ensure business continuity with robust data protection strategies",
      link: "/backup",
    },
  ];
          ...
          <div className="alert-container max-w-2xl mx-auto mb-12">
            <Alert className="bg-blue-950/50 border-blue-400/30 backdrop-blur-sm">
              ...
              <AlertDescription className="text-blue-100">
                <strong className="font-semibold">System Status:</strong> All
                services operational. This appears to be a navigation error, not
                a security breach.
              </AlertDescription>
            </Alert>
          </div>
