...
export default function About() {
  ...
  return (
    <section className="relative  md:py-20 md:min-h-screen flex items-center" id="about">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ">
          ...
          {/* Left Content - Text */}
          <div className=" h-fit pt-5 md:h-[600px]  flex flex-col justify-center space-y-8">
